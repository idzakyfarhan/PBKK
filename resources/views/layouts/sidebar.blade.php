<div class="w-1/6 bg-white h-screen border-r border-gray-200 overflow-hidden sticky left-0 top-0 bottom-0">
    ...
    <div class="px-4 absolute bottom-0 mb-10 w-full flex flex-col gap-2">
                <button
                    class="btn hover:text-white hover:bg-blue-600 text-grey-600 hover:ring-blue-600 text-sm rounded-md w-full p-4 flex justify-start gap-3 ring-2 ring-[#555a64] ring-inset"
                    onclick="my_modal_4.showModal()">Edit Profile
                </button>
