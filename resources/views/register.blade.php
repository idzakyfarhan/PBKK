...
<body class="bg-gray-100 flex justify-center items-center h-screen">
    <div class="w-full max-w-md p-4 bg-white shadow-md rounded-md">
        ...
        <form>
            ...
            <div class="mb-6">
                <label for="confirmPassword" class="block text-gray-600 font-semibold mb-2">Confirmation Password</label>
            ...
            <button type="submit"
                class="w-full px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-md">Signup</button>
        </form>
