    ...
    <div class="flex">
        <div class="w-1/6 bg-white h-screen border-r border-gray-200 overflow-hidden">
            ...
            <div class="flex flex-col gap-3 px-4 mt-2">
                <button class="btn hover:text-white hover:bg-blue-600 hover:ring-blue-600 rounded-lg w-full p-4 flex justify-start gap-3 ring-2 ring-black ring-inset" onclick="my_modal_4.showModal()">Edit Profile</button>
                            ...
                            <form class="max-w-2xl bg-white p-8 rounded-lg">
                                ...
                                <div class="space-y-4">
                                    <div class="w-full">
                                        ...
                                        <input class="w-full px-4 py-2 rounded-lg border focus:outline-none focus:border-slate-500
                                            focus:ring focus:ring-slate-500" type="text">
                                    </div>
                                    <div class="w-full">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <textarea class="w-full px-4 py-2 rounded-lg border focus:outline-none focus:border-slate-500
                                            focus:ring focus:ring-slate-500" name="bio"></textarea>
                                    </div>
                                    <div class="flex justify-end">
                                        <button class="px-6 py-3 text-white bg-violet-700 rounded-md hover:bg-violet-500
                                            focus:outline-none focus:ring focus:ring-violet-500" type="submit">Save Changes</button>
                                    </div>
                                </div>
                            </form>
                        </div>
