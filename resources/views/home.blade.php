...
@section('content')
    ...
    <form action="{{ route('home') }}" method="GET" class="p-4">
        <div class="relative">
            ...
            <input type="text" name="search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-[#2AA9E0] focus:border-[#2AA9E0]" placeholder="Search tweet..." required>
